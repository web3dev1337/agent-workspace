...
describe('AuditExportService', () => {
  ...
  beforeEach(() => {
    ...
    fs.writeFileSync(activityPath, `${JSON.stringify({
      ...
      data: {
        ...
        token: 'fixture_token_value_123456789012345',
    ...
    fs.writeFileSync(schedulerPath, `${JSON.stringify({
      ...
      command: 'open-advice',
      message: 'bearer fixture_api_key_abcdefghijklmnopqrstuvwxyz123456'
    })}\n`);
  ...
  test('exports redacted JSON records from both sources', async () => {
    ...
    expect(asText).not.toContain('fixture_token_value_123456789012345');
