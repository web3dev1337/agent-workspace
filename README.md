...
- **Tier System (T1-T4)** — Organize sessions by priority. T1 Focus for active work, T2 Secondary runs alongside, T3 Background for batch work, T4 Overnight for autonomous tasks.
