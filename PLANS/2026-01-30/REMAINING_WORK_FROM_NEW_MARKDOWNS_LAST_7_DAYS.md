...
Scope: markdown files added in the last 7 days via git history.

## Summary
- Scanned: 24
- With remaining markers: 2
- With no remaining markers: 22
...
- Remaining markers: 7 (unchecked: 7, TODO/FIXME: 0)
- Classification: template/guide
