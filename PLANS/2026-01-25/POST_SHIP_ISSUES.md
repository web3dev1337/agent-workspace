...
- [ ] Status lights: investigate remaining green/orange/grey flicker for agent + worktree dots (esp. Codex sessions). (Mitigation: treat `*-claude` terminals as “busy” for longer quiet windows, PR #398)
