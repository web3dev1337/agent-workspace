...
- [ ] “Background” mode improvements: triage queue + auto-scheduling rules (e.g., tiered retries, safe backoff).
  ...
  - [x] Background triage Queue preset (T3+T4) + snooze (“safe backoff”). (PR #TBD)
...
- [ ] Dashboard “Advice” tile shows “Failed to load” (investigate `/api/process/advice` errors on fresh startups). (PR #323)
